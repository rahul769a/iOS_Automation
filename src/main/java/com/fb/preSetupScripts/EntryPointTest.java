package com.fb.preSetupScripts;
...
public class EntryPointTest {
	...
	public FetchData test() throws Exception {
		...
		File appPath = new File(appDir, ConfigurationLibrary.fileName);
		...
		String authToken = pCloudyCONNECTOR.authenticateUser(
				"vedesh.kumar@techendeavour.com", "j5dy4stx2qvm28ww647cygw3");
		...
		//MobileDevice choosenDevice = devices[3 - 1];
